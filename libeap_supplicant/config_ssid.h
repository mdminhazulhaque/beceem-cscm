...
struct wpa_ssid {
	...
	/**
	 * device_subca1_cert - File path to 1st Device SUB CA certificate file (PEM/DER)
	 * Sub CA1 is the SUB CA certificate signed by the root CA.
	 * This field is used with EAP method that use TLS authentication.
	 * Full path to the file should be used since working directory may change when
	 * wpa_supplicant is run in the background.
	 *
	 * Alternatively, a named configuration blob can be used by setting
	 * this to blob://<blob name>.
	 */
	u8 *device_subca1_cert; 

	/**
	 * device_subca2_cert - File path to 2nd Device Sub CA certificate file (PEM/DER)
	 * SUB CA2 is the SUB CA signed by the SUB CA1.
	 * This field is used with EAP method that use TLS authentication.
	 * Full path to the file should be used since working directory may change when
	 * wpa_supplicant is run in the background.
	 *
...
#define MAX_WEP_KEY_LEN 16
	...
	/**
	 * Max EAP fragment size
	 * Added by CMP - 26 Feb 2009
	 */
	int fragment_size;
	
	/**
	 * OpenSSL cipher rule
	 * Added by CMP - 17 Aug 2009
	 */
	char *cipher_rule;
