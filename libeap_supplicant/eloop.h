 ...
 */
// Modified Jun 2007 to allow operation as a WiMAX supplicant when
// wimax_mode = 1.
 ...
 */
void eloop_terminate(void);    // sets the terminate flag
void eloop_wait_terminate(void);   // waits for eloop to stop running
void eloop_clear_terminate(void);  // clears the terminate flag
