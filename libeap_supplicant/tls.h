 ...
 * DER format
 * @	device_subca1_cert: File or reference name for 1st SUB CA X.509  
 * certificate in PEM or DER format
 * @	device_subca2_cert: File or reference name for 2nd SUB CA X.509  
 * certificate in PEM or DER format.
...
struct tls_connection_params {
	...
	const char *device_subca1_cert; 
	const u8 *device_subca1_cert_blob;
	size_t device_subca1_cert_blob_len;
	const char *device_subca2_cert;
	const u8 *device_subca2_cert_blob;
	size_t device_subca2_cert_blob_len;
